...
// KafkaFormater formats log information to JSON format with time and line number in file
type KafkaFormater struct {
	ShowLn bool
}

func (f *KafkaFormater) Format(entry *logrus.Entry) ([]byte, error) {
