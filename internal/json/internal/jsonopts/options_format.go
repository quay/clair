...
// recognized by the "github.com/quay/clair/v4/internal/json" runtime.
...
// as either a failed experiment or be formally included in "github.com/quay/clair/v4/internal/json"
// in some semantically similar form, in which case, users of this option
// must migrate to the officially supported feature.
//
// The `format` tag was originally part of the "github.com/quay/clair/v4/internal/json" experiment
// but support for it was removed (see https://go.dev/issue/79071) for the
// initial release of "github.com/quay/clair/v4/internal/json" in light of the anticipation that
...
//
// While "github.com/quay/clair/v4/internal/json" was in the experimental phase,
...
// formatting directives in "github.com/quay/clair/v4/internal/json" using that language mechanism.
//
