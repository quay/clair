...
# in dist artifacts.
#
# This should be able to be interpreted accorting to gitrevisions(7) and a
...
ifndef IMAGE_NAME
$(error 'IMAGE_NAME' not defined, need at least on comma-separated value)
endif
